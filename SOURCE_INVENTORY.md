...
| Generated figures | Not present | Original empirical plots | Missing | The report PDF contains figures, but no source images/data were supplied. The deck uses report-grounded tables and native schematics; it does not fabricate empirical curves. |
...
- Native graphics in the deck are either exact redraws of submitted tabular values or explicitly labelled conceptual schematics.
