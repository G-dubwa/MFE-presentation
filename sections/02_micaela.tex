...
%=========================================================
% PARAMETER RANGES — ONE LINE
%=========================================================
{\footnotesize
\[
\makebox[0.97\textwidth][s]{%
  \(K\in\{0.8,0.9,1.0,1.1,1.2\}\)
  \hfill
  \(\sigma\in\{0.2,0.4,0.6\}\)
  \hfill
...
\begin{column}{0.335\textwidth}
    ...
    % Result 1
    \noindent
    {\color{Teal}\(\blacktriangleright\)}
    \hspace{0.08cm}
    \begin{minipage}[t]{0.88\linewidth}
        Mean neural-to-optimal RMSE ratio
    \end{minipage}

    \vspace{0.12cm}

    \begin{center}
        \fbox{\fontsize{17}{19}\selectfont \(1.049\)}
    \end{center}
    ...
    \hspace{0.08cm}
    \begin{minipage}[t]{0.88\linewidth}
        Neural hedge remains at most
    \end{minipage}

    \vspace{0.12cm}

    \begin{center}
        \fbox{\fontsize{17}{19}\selectfont \(10\%\)}
    \end{center}

    \vspace{-0.06cm}

    \begin{center}
        {\scriptsize above the discrete-time optimum}
    \end{center}
    ...
    \hspace{0.08cm}
    \begin{minipage}[t]{0.88\linewidth}
        Largest relative gap occurs at
    \end{minipage}
...
\begin{column}{0.31\textwidth}
    ...
    % Move content closer to the graph and slightly lower
    \hspace*{-0.28cm}
    ...
    %---------------- Result 1 ----------------
    \noindent
    {\color{Teal}\scriptsize\(\blacktriangleright\)}
    \hspace{0.04cm}
    {\footnotesize Mean neural-to-optimal RMSE ratio}
    ...
    {\color{Teal}\scriptsize\(\blacktriangleright\)}
    \hspace{0.04cm}
    {\footnotesize Neural hedge remains at most}
    ...
    {\color{Teal}\scriptsize\(\blacktriangleright\)}
    \hspace{0.04cm}
    {\footnotesize Largest relative gap occurs at}
...
\begin{itemize}
    ...
    \item Maximum RMSE gap:
    \[
        \boxed{\leq 0.00018}.
    \]

    \item Performance remains close to the discrete-time optimum
    throughout the trained region.
...
\begin{itemize}
    ...
    \item At \(\sigma=0.1\), the worst RMSE is approximately
    \[
        \boxed{3\times}
    \]
    the optimum.
